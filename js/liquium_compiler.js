...
function compile(opts, fileName, cb) {
    ...
    return async.series([
        ...
        function(cb) {
            ...
            S += "exports.organizationByteCode = "+JSON.stringify(organizationByteCode) + ";\n";
            S += "exports.delegateStatusFactoryAbi = "+JSON.stringify(delegateStatusFactoryAbi) +";\n";
            S += "exports.delegateStatusFactoryByteCode = "+JSON.stringify(delegateStatusFactoryByteCode) + ";\n";
            S += "exports.delegateStatusAbi = "+JSON.stringify(delegateStatusAbi) +";\n";
            S += "exports.delegateStatusByteCode = "+JSON.stringify(delegateStatusByteCode) + ";\n";
            S += "exports.singleChoiceAbi = "+JSON.stringify(singleChoiceAbi) +";\n";
            S += "exports.singleChoiceByteCode = "+JSON.stringify(singleChoiceByteCode) +";\n";
